...
/*!
* @nutui/nutui v3.1.9 Tue Oct 12 2021 13:47:53 GMT+0800 (中国标准时间)
* (c) 2021 @jdf2e.
...
(function(global, factory) {
  ...
  const _hoisted_6$a = { class: "bottom-text" };
  const _hoisted_7$8 = {
    key: 1,
    class: "tips"
  };
    ...
    return vue.openBlock(), vue.createElementBlock("view", {
      ...
      vue.createElementVNode("view", _hoisted_4$h, [
        _ctx.isInfiniting ? (vue.openBlock(), vue.createElementBlock("view", _hoisted_5$d, [
          ...
          vue.createElementVNode("view", _hoisted_6$a, vue.toDisplayString(_ctx.loadTxt), 1)
    ...
    return vue.openBlock(), vue.createElementBlock("view", {
      ...
      vue.createElementVNode("view", _hoisted_4$e, [
        ...
        _ctx.content ? (vue.openBlock(), vue.createElementBlock("view", {
          ...
          innerHTML: _ctx.content
        }, null, 8, _hoisted_6$7)) : vue.createCommentVNode("", true)
      ])
    ], 2);
  }
  ...
  const _sfc_main$b = create$b({
    ...
    setup(props, { emit }) {
      ...
      const topNumber = (index) => {
        ...
        let idx1 = sortFlag == "add" ? String(initDigit2)[index - (num_total_len - pointNum)] : 10 - Number(String(initDigit2)[index - (num_total_len - pointNum)]);
    ...
    return vue.openBlock(), vue.createElementBlock("view", _hoisted_1$a, [
      _ctx.customBgImg != "" ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
        ...
        _ctx.scrolling ? (vue.openBlock(), vue.createElementBlock("view", {
          key: 0,
          class: "run-number",
          style: vue.normalizeStyle({ height: _ctx.numHeight + "px", lineHeight: _ctx.numHeight + "px" })
        }, [
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.num_total_len, (val, index) => {
            return vue.openBlock(), vue.createElementBlock("view", {
              ref: "numberItem",
            ...
            vue.createElementVNode("view", _hoisted_7, [
              vue.createElementVNode("ul", _hoisted_8, [
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.regionList[_ctx.tabName[_ctx.tabIndex]], (item, index) => {
                  return vue.openBlock(), vue.createElementBlock("li", {
                    key: index,
                    class: vue.normalizeClass(["region-item", [
