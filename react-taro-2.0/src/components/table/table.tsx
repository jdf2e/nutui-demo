...
import { Button, Toast, Table } from '@nutui/nutui-react-taro'
...
const TableDemo = () => {
  ...
  const [columns1, ] = useState<Array<any>>([
    {
      title: '姓名',
      key: 'name',
    },
  ...
  const [columns2, ] = useState<Array<any>>([
    {
      title: '姓名',
      key: 'name',
      align: 'center',
  ...
  const [columns4, ] = useState<Array<any>>([
    {
      title: '姓名',
      key: 'name',
      align: 'center',
  ...
  const [columns5, ] = useState<Array<any>>([
    {
      title: '姓名',
      key: 'name',
      align: 'center',
  ...
  const handleSorter = (item: any, data: Array<any>) => {
    setData5([...data])
  }
